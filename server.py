...
app = Flask(__name__)
es = Elasticsearch('http://search-logos-6umf542a67vp6szlwnciiianaa.sa-east-1.es.amazonaws.com',ca_certs=False,verify_certs=False, timeout=60, max_retries=10, retry_on_timeout=True)
